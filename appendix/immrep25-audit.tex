...
and two OLGA controls (raw random and generation-probability--matched) that fix the
noise floor at S/N${=}1$. On both probes and both chains the immrep25 positives sit
just above that floor and one to three orders of magnitude below every quality
cohort; their weak homology is fully explained by public TCRs (it collapses to the
floor once public TCRs are removed) and their inter-chain pairing shows essentially
no coupling. We conclude the positive labels carry no meaningful epitope-specific
