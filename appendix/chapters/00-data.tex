...
($n$ = number of qualifying epitopes); no bootstrap resampling is used. The two
OLGA controls fix the noise floor: raw random draws and draws whose per-chain
generation probability is matched to immrep25 (so chance matchability is controlled).
