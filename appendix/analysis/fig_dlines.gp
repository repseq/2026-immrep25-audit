...
# (2 tcrvdb_true, 3 vdjdb_hq, 4 vdjdb_lq, 5 tcrvdb_false, 6 immrep25, 7 airr_control,
#  8 airr_top, 9 olga_random, 10 mlr_prolif [beta only -> blank on TCRalpha panel])
...
set style line 10 lc rgb '#35978f' lw 3 pt 6
do for [pane in "A B"] {
  ...
  plot f u 1:2 w lp ls 1 t 'TCRvdb true', f u 1:3 w lp ls 2 t 'VDJdb HQ', \
       ...
       f u 1:6 w lp ls 5 t 'immrep25', f u 1:7 w lp ls 8 t 'AIRR random', \
       f u 1:8 w lp ls 9 t 'AIRR nonrand', \
       f u 1:9 w lp ls 7 t 'OLGA rand', f u 1:10 w lp ls 10 t 'MLR exp.\ $\beta$', \
