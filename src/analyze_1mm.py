...
COHORTS = ["immrep25_pos", "immrep22_true", "airr_control", "airr_top", "olga_random"]
LAB = {"immrep25_pos": "immrep25", "immrep22_true": "IMMREP22 true",
       "airr_control": "AIRR random", "airr_top": "AIRR non-random", "olga_random": "OLGA random"}
COL = {"immrep25_pos": "#FF7F00", "immrep22_true": "#4393C3", "airr_control": "#9e9ac8",
       "airr_top": "#6a51a3", "olga_random": "#B2182B"}
